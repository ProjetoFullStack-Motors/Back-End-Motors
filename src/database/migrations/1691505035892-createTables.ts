...
export class CreateTables1691505035892 implements MigrationInterface {
    name = "CreateTables1691505035892";
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            "CREATE TABLE \"salesAd\" (\"id\" character varying NOT NULL, \"created_at\" bigint NOT NULL, \"brand\" character varying(255) NOT NULL, \"model\" character varying(255) NOT NULL, \"color\" character varying(255) NOT NULL, \"engine\" \"public\".\"salesAd_engine_enum\" NOT NULL, \"description\" text NOT NULL, \"year\" date NOT NULL, \"mileage\" integer NOT NULL, \"price\" integer NOT NULL, \"status\" boolean NOT NULL DEFAULT true, \"isGoodPrice\" boolean NOT NULL, CONSTRAINT \"PK_5e76654310265ee7cbf2a0c8cdf\" PRIMARY KEY (\"id\"))"
        );
        await queryRunner.query(
            "CREATE TABLE \"salesImages\" (\"id\" character varying NOT NULL, \"created_at\" bigint NOT NULL, \"imageUrl\" text NOT NULL, \"principal\" boolean NOT NULL, \"salesAdId\" character varying, CONSTRAINT \"PK_da26936c1ff5c5508c1b4d8922c\" PRIMARY KEY (\"id\"))"
        );
        await queryRunner.query(
