...
export class CreateTables1691525711937 implements MigrationInterface {
    name = 'CreateTables1691525711937'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."salesAd_engine_enum" AS ENUM('flex', 'hybrid', 'electric')`);
        await queryRunner.query(`CREATE TABLE "salesAd" ("id" character varying NOT NULL, "created_at" text NOT NULL, "brand" character varying(255) NOT NULL, "model" character varying(255) NOT NULL, "color" character varying(255) NOT NULL, "engine" "public"."salesAd_engine_enum" NOT NULL, "description" text NOT NULL, "year" character varying(4) NOT NULL, "mileage" integer NOT NULL, "price" integer NOT NULL, "status" boolean NOT NULL DEFAULT true, "isGoodPrice" boolean NOT NULL, CONSTRAINT "PK_5e76654310265ee7cbf2a0c8cdf" PRIMARY KEY ("id"))`);
